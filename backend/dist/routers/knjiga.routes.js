...
knjigaRouter.route('/produzi').post((req, res) => new knjiga_controller_1.KnjigaController().produzi(req, res));
knjigaRouter.route('/odobri').post((req, res) => new knjiga_controller_1.KnjigaController().odobri(req, res));
knjigaRouter.route('/odbi').post((req, res) => new knjiga_controller_1.KnjigaController().odbi(req, res));
